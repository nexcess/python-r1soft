# @source https://raw.githubusercontent.com/icatproject/python-icat/3ae9cdb685d0f10432ad3f6ec17bb00fd13fc793/icat/sslcontext.py
...
class HTTPSTransport(suds.transport.https.HttpAuthenticated):
    ...
    def u2handlers(self):
        ...
        """
        handlers = suds.transport.https.HttpAuthenticated.u2handlers(self)
        if self.ssl_context:
            try:
